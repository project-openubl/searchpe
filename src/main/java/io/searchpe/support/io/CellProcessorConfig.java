        ...
        for (int x = processorValuesInThisLine.size() - 1; x >= 0; x--) {
            ...
            if (name.equalsIgnoreCase("null")) {
                ...
                if (params.length == 0) {
                    ...
                    current = previous == null ? new RequireHashCode(TxtItemReader.convertToIntParams(params, 0, params.length)) :
                            new RequireHashCode(TxtItemReader.convertToIntParams(params, 0, params.length), previous);
                }
                ...
                if (params.length == 1) {
                    ...
                    current = previous == null ? new Strlen(TxtItemReader.convertToIntParams(params, 0, params.length)) :
                            new Strlen(TxtItemReader.convertToIntParams(params, 0, params.length), previous);
                }
    ...
    private static CellProcessor createCustomCellProcessor(final String name,
        ...
        try {
            ...
            if (params.length == 0) {
                ...
                if (previous == null) {
                    constructorParamTypes = TxtItemReaderWriterBase.stringParameterTypes;
                    final Constructor<?> constructor = cellProcessorClass.getConstructor(constructorParamTypes);
